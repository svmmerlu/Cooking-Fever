...
class Level4{
    ...
    public Level4(){
        ...
        orders = new int[]{LETTUCEBURGER, BURGER, COLA, HOTDOG, KETCHUPHOTDOG, BURGER, COLA, COLA, LETTUCEBURGER, LETTUCEBURGER, BURGER, HOTDOG, COLA, COLA};
        
        people = new Person[]{new Person(PONYTAILWOMAN), new Person(OLDWOMAN), new Person(BLONDEMAN), 
                              new Person(FLUFFYHATMAN), new Person(BLONDEPIXIEWOMAN), new Person(PURPLEHATWOMAN),
                              new Person(BLONDEPIXIEWOMAN), new Person(FLUFFYHATMAN), new Person(PURPLEHATWOMAN),
                              new Person(GREYHOODIEKID), new Person(OLDWOMAN), new Person(PONYTAILWOMAN), 
        ...
        spawntime = new long[]{3000, 6000, 9000, 12000, 36000, 39000, 42000, 45000, 69000, 72000, 75000, 78000, 94000, 97000};
    }
